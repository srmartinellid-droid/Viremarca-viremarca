        ...
        <div className="md:col-span-5">
          ...
          <div className="mt-9">
            {data.items.map((item, i) => {
              ...
              return (
                <motion.article key={item.title} initial={reduced ? false : { opacity: 0, y: 22 }} whileInView={reduced ? undefined : { opacity: 1, y: 0 }} viewport={{ once: true, margin: "-6% 0px" }} transition={{ duration: 0.65, ease: [0.22, 1, 0.36, 1] }} className="border-b border-white/10 py-5 first:pt-0">
