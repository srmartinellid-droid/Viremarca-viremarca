                ...
                >
                  ...
                  <div className="p-5 md:p-6 bg-white">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <Link onClick={() => void trackEvent("portfolio_view", { location: "portfolio_card" }, "production")} href={`/portfolio/${project.slug}`} className="shrink-0 flex h-10 w-10 items-center justify-center rounded-full border border-vm-border group-hover:border-vm-coral group-hover:bg-vm-coral group-hover:text-white transition-all" aria-label={`Ver ${project.title}`}><ArrowUpRight size={16} /></Link>
                    </div>
                  </div>
                </motion.article>
              )
