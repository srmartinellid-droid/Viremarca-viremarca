              ...
              return (
                ...
                >
                  <div className="relative aspect-[4/3] overflow-hidden bg-vm-sand">
                    ...
                    <div className="absolute top-4 left-4 flex flex-wrap gap-2"><span className="rounded-full bg-white/90 backdrop-blur-sm px-3 py-1 text-[11px] font-medium text-vm-ink tracking-wide">{project.category}</span></div>
