    ...
    <section id="quem-somos" className="relative overflow-hidden bg-vm-sand py-24 md:py-32">
      ...
      <div className="mx-auto max-w-[1400px] px-5 sm:px-8 lg:px-12">
        <div className="grid gap-12 lg:grid-cols-[0.72fr_1.28fr] lg:gap-20">
          <Reveal><div className="sticky top-28 lg:pl-6"><TitleBlock style={title} className="!mx-0 !text-left" size="h2" /><div className="mt-10 flex items-center gap-3 text-[10px] font-semibold uppercase tracking-[0.2em] text-vm-muted"><span className="h-2 w-2 rounded-full bg-vm-coral" />VireMarca®</div></div></Reveal>
