...
export async function getPublicSiteContent(): Promise<PublicSiteContent> {
  ...
  try {
    ...
    const commercial = { ...fallback.commercial, pillars: { ...fallback.commercial.pillars, ...parseJsonObject(values.pillars_json, {}) }, solutions: { ...fallback.commercial.solutions, ...parseJsonObject(values.solutions_json, {}), demos: parseJsonObject<ConversationDemo[]>(parseJsonObject<Record<string, unknown>>(values.solutions_json, {}).demos as string | undefined, fallback.commercial.solutions.demos) }, diagnostic: { ...fallback.commercial.diagnostic, ...parseJsonObject(values.diagnostic_json, {}) } }
